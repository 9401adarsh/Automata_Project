...
void TM_S( int *var )       // TM_S - Utility function to initialise state for transition function
{
   if(symbol == _q) 
   {
      nextSymbol();
...
void PrintConfiguration(int q, string t, int h)     //Utility function to print configuration
{
   char c;
   int i;
